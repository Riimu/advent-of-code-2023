...
class TaskResultTest extends TestCase
{
    ...
    public static function resultTestProvider(): iterable
    {
        return [
            ...
            [Task\Day20\Day20Part2Task::class, __DIR__ . '/../../input/day-20-input.txt', '217317393039529'],

            [Task\Day21\Day21Part1Task::class, __DIR__ . '/../../input/day-21-input.txt', '3682'],
            [Task\Day21\Day21Part2Task::class, __DIR__ . '/../../input/day-21-input.txt', '609012263058042'],

            [Task\Day22\Day22Part1Task::class, __DIR__ . '/../../input/day-22-sample-1.txt', '5'],
            [Task\Day22\Day22Part1Task::class, __DIR__ . '/../../input/day-22-input.txt', '517'],
            [Task\Day22\Day22Part2Task::class, __DIR__ . '/../../input/day-22-sample-1.txt', '7'],
            [Task\Day22\Day22Part2Task::class, __DIR__ . '/../../input/day-22-input.txt', '61276'],

            [Task\Day23\Day23Part1Task::class, __DIR__ . '/../../input/day-23-sample-1.txt', '94'],
            [Task\Day23\Day23Part1Task::class, __DIR__ . '/../../input/day-23-input.txt', '2438'],
            [Task\Day23\Day23Part2Task::class, __DIR__ . '/../../input/day-23-sample-1.txt', '154'],
            [Task\Day23\Day23Part2Task::class, __DIR__ . '/../../input/day-23-input.txt', '6658'],
        ];
    }
}
